...
{
    QString currentDescription = DisplayedDataSet->getDescription(); // getcurrentdescription
    QString currentName = DisplayedDataSet->getName();
    ChangeDataSetInfoDialog* ChangeDataSetName_dlg = new ChangeDataSetInfoDialog(this, currentDescription, currentName);
